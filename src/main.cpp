...
// Copyright (c) 2013-2014 The Dimecoin developers
...
#if defined(NDEBUG)
# error "Dime cannot be compiled without assertions."
#endif
...
static const int64_t nTargetTimespan = 65536 ; // about 18 hour
static const int64_t nTargetSpacing = 64; // 64 seconds
static const int64_t nInterval = nTargetTimespan / nTargetSpacing; // 1024 blocks
