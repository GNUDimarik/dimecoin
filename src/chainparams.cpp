...
unsigned int pnSeed[] =
{
    0xD374CB09, 0x36A4FCFF, 
};

static const unsigned int timeMainGenesisBlock = 1387807823;
uint256 hashMainGenesisBlock("0x00000d5a9113f87575c77eb5442845ff8a0014f6e79e2dd2317d88946ef910da");
static CBigNum bnMainProofOfWorkLimit(~uint256(0) >> 20);

static const int64_t nGenesisBlockRewardCoin = 1 * COIN;
static const int64_t nBlockRewardStartCoin = 1024 * COIN;
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("dimecoin.us", "seed.dimecoin.us"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x04)(0x88)(0xC4)(0x2C);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x04)(0x88)(0xBF)(0xF2);
